...
func ShowFull(w io.Writer, catalog providers.Catalog) {
	fmt.Fprintf(w, "ZaibFlow v%s\n", version.Value)
	fmt.Fprintln(w, "Run Claude Code with any AI provider")
	fmt.Fprintln(w)
